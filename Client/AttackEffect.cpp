...
unsigned int WINAPI E_Attack(void* param)
{
    ...
    sprintf_s(_tmp, "¡á %c¡á", (char)data["skin"].asInt());
	...
	sprintf_s(_tmp, "¡à¡á%c ¡á¡à", (char)data["skin"].asInt());
	...
	sprintf_s(_tmp, "¢·¡á¡á%c ¡á¡á¢¹", (char)data["skin"].asInt());
	...
	sprintf_s(_tmp, "¢·    %c     ¢¹", (char)data["skin"].asInt());
